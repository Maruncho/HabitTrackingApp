...
public interface ISessionRepository : _PredicatesExtra<int>
{
    ...
    public Task<bool> UpdateGoodHabits(int[] ids, string userId);
    ...
    public Task<bool> UpdateBadHabits(int[] ids, string userId);
    ...
    public Task<bool> UpdateTreats(Tuple<int, byte>[] idsAndUnitsPerSession, string userId);
