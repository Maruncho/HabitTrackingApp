...
namespace HabitTrackingApp.Data.Migrations
{
    ...
    [Migration("20240927104544_ImplementSessions")]
    partial class ImplementSessions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.AppUser", b =>
                {
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.Core.BadHabit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.Core.GoodHabit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.Core.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.Core.TransactionType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.Core.Treat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.SessionModels.Session", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.SessionModels.SessionBadHabit", b =>
                {
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.SessionModels.SessionGoodHabit", b =>
                {
                    b.Property<int>("SessionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.SessionModels.SessionTransaction", b =>
                {
                    b.Property<int>("SessionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.SessionModels.SessionTreat", b =>
                {
                    b.Property<int>("SessionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.Core.BadHabit", b =>
                {
                    b.HasOne("HabitTrackingApp.Data.AppUser", "User")
                        .WithMany("BadHabits")
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.Core.Transaction", b =>
                {
                    b.HasOne("HabitTrackingApp.Data.Core.TransactionType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.SessionModels.SessionBadHabit", b =>
                {
                    b.HasOne("HabitTrackingApp.Data.Core.BadHabit", "BadHabit")
                        .WithMany("SessionBadHabits")
                        .HasForeignKey("BadHabitId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("HabitTrackingApp.Data.SessionModels.Session", "Session")
                        .WithMany("SessionBadHabits")
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.SessionModels.SessionGoodHabit", b =>
                {
                    b.HasOne("HabitTrackingApp.Data.Core.GoodHabit", "GoodHabit")
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.SessionModels.SessionTransaction", b =>
                {
                    ...
                    b.HasOne("HabitTrackingApp.Data.Core.Transaction", "Transaction")
                        .WithMany()
            ...
            modelBuilder.Entity("HabitTrackingApp.Data.SessionModels.SessionTreat", b =>
                {
                    ...
                    b.HasOne("HabitTrackingApp.Data.Core.Treat", "Treat")
                        .WithMany("SessionTreats")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HabitTrackingApp.Data.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
